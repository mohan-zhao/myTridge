...
#' y vector,with ,dimension=X.rows
#' A dataset randomly generate the output vector
#'
#' @format 
#' \describe{get by calling TridgeEst function
...
#' A Test case 
#' selected from three different distributions 
#'
#' @format 
#' \describe{get by calling TridgeEst function
#'   \item{Test.case_bin}{input test case, here "binomial"}
#'   ...
#' }
"Test.case_bin"
...
#' @format 
#' \describe{get by calling TridgeEst function
#'   \item{Test.case_poi}{input test case, here "poisson"}
#'   ...
#' }
"Test.case_poi"
...
#' @format 
#' \describe{get by calling TridgeEst function
#'   \item{Test.case_gau}{input test case, here "gaussian"}
#'   ...
#' }
"Test.case_gau"